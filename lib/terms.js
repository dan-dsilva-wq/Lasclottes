...
const BOOKING_TERMS_VERSION = '2026-08-26-draft-5';
...
const BOOKING_TERMS_TEXT = [
    ...
    'Price and payment: The accommodation price is shown in pounds sterling (GBP). If arrival is more than 60 days away, a non-refundable 20% booking payment is due on confirmation. The remaining accommodation balance and the refundable GBP 500 damage deposit are due 60 days before arrival. When booking within 60 days of arrival, the full accommodation price and damage deposit are due on confirmation.',
    ...
    'Cancellation: If the guest cancels more than 60 days before arrival, the 20% booking payment is not refundable and no further accommodation payment is due. The position for a cancellation, curtailment or failure to arrive within 60 days will be stated in the booking confirmation. Suitable travel insurance is strongly recommended.',
