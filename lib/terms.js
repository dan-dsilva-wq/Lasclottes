...
const BOOKING_TERMS_VERSION = '2026-08-26-draft-4';
...
const BOOKING_TERMS_TEXT = [
    ...
    'Tourist tax: Tourist tax is not included in the GBP card figures. Its amount depends on the accommodation classification and the official rate then in force. Lasclottes will confirm the amount in euros, the people to whom it applies and the payment method before the balance is due.',
