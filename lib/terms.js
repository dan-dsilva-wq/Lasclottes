...
const BOOKING_TERMS_VERSION = '2026-08-25-draft-1';
...
const BOOKING_TERMS_TEXT = [
    ...
    'Tourist tax: The statutory tourist tax is shown separately in euros at EUR 1.41 per adult per night. It is not included in the GBP card figures. Lasclottes will confirm the amount and payment method before the balance is due.',
