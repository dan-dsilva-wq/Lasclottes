...
const calculateQuote = (input, now = new Date(), blocked = AVAILABILITY.blocked) => {
    ...
    if (blockedDateRange(arrival, departure, blocked)) {
...
const validateContact = (input) => {
    ...
    return { firstName, lastName, email, phone, lang };
};
