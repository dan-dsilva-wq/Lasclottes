...
const copyForLanguage = (language) => {
    if (language === 'fr') {
        return {
            ...
            tax: 'Taxe de séjour séparée', contact: 'Vos coordonnées',
    ...
    if (language === 'nl') {
        return {
            ...
            tax: 'Afzonderlijke toeristenbelasting', contact: 'Uw contactgegevens',
    ...
    return {
        ...
        tax: 'Separate tourist tax', contact: 'Your contact details',
